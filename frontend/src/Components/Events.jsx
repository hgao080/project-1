...
const Events = ({ events, user }) => {
    return (
        <div className="flex flex-col items-center w-full mt-4">
            ...
            {user ? <p className="flex justify-center bg-golden-yellow border border-black w-full mt-4 rounded py-2 font-main font-bold text-2xl">Once you join an event you will not be allowed to unjoin.</p> : ''}
